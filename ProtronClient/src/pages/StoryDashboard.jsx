...
const StoryDashboard = () => {
  ...
  const openAddBasedOnType = (initialStatus = null, parentForTask = null) => {
    ...
    if (Array.isArray(typeDropdowns.level2)) {
      level2IsSS = typeDropdowns.level2.some(v => String(v).toLowerCase() === 'solution story');
    } else if (typeDropdowns.level2) {
      level2IsSS = String(typeDropdowns.level2).toLowerCase() === 'solution story';
    }
  ...
  const getAddButtonLabel = () => {
    if (typeDropdowns.level3 && String(typeDropdowns.level3).toLowerCase() === 'task') return 'Add Task';
