  ...
  const validateForm = () => {
    ...
    if (!formData.vendorName?.trim()) {
      newErrors.vendorName = "Vendor name is required";
         ...
         if (!formData.systemId && !formData.systemName?.trim()) {
       newErrors.systemId = "System is required";
       newErrors.systemName = "System is required";
     } else {
       // Clear both errors if either is provided
       if (newErrors.systemId) delete newErrors.systemId;
       if (newErrors.systemName) delete newErrors.systemName;
     }
    ...
    if (budgetLine && formData.amount) {
      ...
      const remainingBudget = parseFloat(budgetLine.amountApproved || 0) - totalAllocated;
